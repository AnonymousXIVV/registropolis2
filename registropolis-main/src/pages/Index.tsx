...
const Index = () => {
  ...
  const handleExploreFeature = (feature: string) => {
    if (isAuthenticated) {
      ...
      navigate('/auth', { state: { redirectTo: `/dashboard/${feature}` } });
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin-slow">
          <div className="w-16 h-16 rounded-full border-t-4 border-b-4 border-primary"></div>
        </div>
      </div>
    );
  }
  ...
  const keyHighlights = [
    {
      ...
      description: "Connect with businesses and users through our real-time messaging platform.",
      feature: "messages"
    },
    {
      icon: <Pizza className="w-12 h-12 text-orange-500" />,
      title: "Food Delivery",
      description: "Order from local restaurants or become a home chef. Negotiate prices in real-time.",
      feature: "food"
    },
    {
      icon: <Car className="w-12 h-12 text-green-500" />,
      title: "Taxi Services",
      description: "Book rides and negotiate fares directly with drivers in your area.",
      feature: "taxi"
    },
    {
      icon: <ShoppingBag className="w-12 h-12 text-purple-500" />,
      title: "Marketplace",
      description: "Buy, sell, or trade items in your local community marketplace.",
      feature: "marketplace"
    },
    {
      icon: <Briefcase className="w-12 h-12 text-indigo-500" />,
      title: "Jobs",
      description: "Find job opportunities or post positions for your business.",
      feature: "jobs"
    },
    {
      icon: <Building className="w-12 h-12 text-red-500" />,
      title: "Real Estate",
      description: "Browse properties, connect with agents, and find your next home.",
      feature: "real-estate"
    },
    {
      icon: <Calendar className="w-12 h-12 text-teal-500" />,
      title: "Events",
      description: "Discover and organize local events in your community.",
      feature: "events"
    },
    {
      icon: <ShieldCheck className="w-12 h-12 text-cyan-500" />,
      title: "Secure Platform",
      description: "Register to unlock full features while browsing freely as a guest.",
      feature: "settings"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Browse services freely as a guest. Register to unlock messaging and premium features.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {keyHighlights.map((highlight, index) => (
                <motion.div 
                  ...
                  onClick={() => handleExploreFeature(highlight.feature)}
                >
