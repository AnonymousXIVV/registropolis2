    ...
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col pt-4">
        <div className="flex justify-between items-start mb-4">
          ...
          <RatingDisplay rating={restaurant.rating} reviews={restaurant.reviews} size="sm" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 text-sm text-muted-foreground mb-4">
          ...
          <div>
            ...
            {negotiatedDeliveryFee && (
              <span className="text-xs line-through ml-1">{restaurant.deliveryFee}</span>
            )}
          </div>
        </div>
        ...
        <div className="mt-auto space-y-2">
          <div className="flex gap-2">
            <Button variant="outline" size="sm" className="flex-1" onClick={handleMessageRestaurant}>
